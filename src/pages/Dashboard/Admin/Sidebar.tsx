  ...
  return (
    <aside className="w-64 bg-indigo-700 text-white flex flex-col">
      ...
      <nav className="flex-1 px-4 py-6 space-y-4">
        ...
        <a href="#" className="flex items-center space-x-3 hover:bg-indigo-600 p-2 rounded">
          <ArrowDown className="w-5 h-5" /> <span>Deposit</span>
        </a>
        <a href="#" className="flex items-center space-x-3 hover:bg-indigo-600 p-2 rounded">
          <ArrowUp className="w-5 h-5" /> <span>Withdraw</span>
        </a>
        <a href="#" className="flex items-center space-x-3 hover:bg-indigo-600 p-2 rounded">
          <Send className="w-5 h-5" /> <span>Send Money</span>
        </a>
        <a href="#" className="flex items-center space-x-3 hover:bg-indigo-600 p-2 rounded">
          <List className="w-5 h-5" /> <span>Transactions</span>
        </a>
        <a href="#" className="flex items-center space-x-3 hover:bg-indigo-600 p-2 rounded">
