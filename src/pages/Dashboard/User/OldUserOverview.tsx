    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <Link to="/user/deposit-money" className="w-full">
          ...
          <Link to="/user/withdraw-money" className="bg-indigo-600 text-white p-4 rounded-xl shadow hover:bg-indigo-700 flex flex-col items-center">
            <ArrowUpRight className="w-6 h-6 mb-2" />
            <span>Withdraw</span>
          </Link>

          <Link to="/user/send-money" className="bg-indigo-600 text-white p-4 rounded-xl shadow hover:bg-indigo-700 flex flex-col items-center">
